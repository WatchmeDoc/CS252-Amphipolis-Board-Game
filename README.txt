The game basically does not allow the user to make any mistakes. It disables and enables
the available buttons properly.
...
>> You can only use "End Turn" button after picking all the tiles required.
